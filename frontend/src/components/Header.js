  ...
  return (
    <header className='h-16 shadow-md bg-white fixed w-full z-40'>
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
        ...
        {/* <div className='h-55 mx-auto min-w-[40px] flex items-center'>
                <Link to={"/"}>
                    <Logo w={5} h={5}/>
...
*/}
        <div className='flex items-center w-full justify-between max-w-sm border rounded-full focus-within:shadow pl-2'>
          ...
          className='w-full outline-none transition-all duration-300 ease-in-out group-hover:w-40 group-hover:opacity-100 outline-none sm:w-full sm:opacity-100' 
          onChange={handleSearch} value={search} />
          <div className='text-lg min-w-[30px] h-8 bg-red-600 flex items-center justify-center rounded-r-full text-white'>
            <GrSearch />
          </div>
        </div>
